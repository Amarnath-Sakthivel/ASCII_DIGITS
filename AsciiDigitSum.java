     ...
     static int AsciiValues(char[] input1,char[] input2){
         ...
         for (int i=0;i<input1.length;i++){                 // comparing input 1 with input 2.
             ...
             for (int j=0;j<input2.length;j++){
                 ...
                 ascii=(int)Character.toUpperCase(input1[i]);     // find ascii values for UpperCase

                 System.out.println(Character.toUpperCase(input1[i])+" "+ascii);
         ...
         for (int i=0;i<input2.length;i++){                     // comparing input 2 with input 1.
             ...
             for (int j=0;j<input1.length;j++){
                 ...
                 ascii=(int)Character.toUpperCase(input2[i]);             // find ascii values for UpperCase
                 System.out.println(Character.toUpperCase(input2[i])+" "+ascii);
